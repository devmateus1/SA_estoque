                ...
                <ul class="dropdown-menu" style="display: none; opacity: 0; transform: translateY(-10px); position: absolute; top: 100%; left: 50%; transform: translateX(-50%) translateY(-10px); background: linear-gradient(135deg, rgba(15, 23, 42, 0.95) 0%, rgba(30, 41, 59, 0.9) 100%); min-width: 280px; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(59, 130, 246, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1); border-radius: 16px; padding: 12px 0; z-index: 1000; backdrop-filter: blur(20px); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);" onmouseenter="this.style.display='block'; this.style.opacity='1'; this.style.transform='translateX(-50%) translateY(0)'" onmouseleave="this.style.opacity='0'; this.style.transform='translateX(-50%) translateY(-10px)'; setTimeout(() => { if(this.style.opacity === '0') this.style.display='none'; }, 300)">
                    <?php foreach($arquivos as $arquivo):?>
                        <li style="list-style: none;">
                            ...
                            <a href="<?=$arquivo ?>" style="display: block; padding: 14px 24px; color: #cbd5e1; text-decoration: none; font-size: 1rem; font-weight: 500; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); border-left: 3px solid transparent; position: relative; background: linear-gradient(90deg, transparent 0%, rgba(59, 130, 246, 0.05) 100%);" onmouseover="this.style.backgroundColor='rgba(59, 130, 246, 0.2)'; this.style.borderLeftColor='#60a5fa'; this.style.paddingLeft='32px'; this.style.color='#ffffff'; this.style.textShadow='0 0 8px rgba(96, 165, 250, 0.6)'" onmouseout="this.style.backgroundColor='rgba(59, 130, 246, 0.05)'; this.style.borderLeftColor='transparent'; this.style.paddingLeft='24px'; this.style.color='#cbd5e1'; this.style.textShadow='none'"> 
                                <span style="position: relative; z-index: 2;">📋 <?= ucfirst(str_replace("_", " ",basename ($arquivo, ".php")))?></span>
                            </a>
                        </li>
                    <?php endforeach; ?> 
                </ul>
