...
<div style="max-width: 1200px; margin: 40px auto; padding: 40px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(15px); border-radius: 20px; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); border: 1px solid rgba(59, 130, 246, 0.2);">
    ...
    <h2 style="text-align: center; color: #1e3a8a; margin-bottom: 30px; font-size: 28px; font-weight: 700; text-shadow: 0 2px 4px rgba(30, 58, 138, 0.1);">Excluir Usuário</h2>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 0;">
                <thead>
                    <tr style="background: linear-gradient(135deg, #1e3a8a, #3b82f6);">
                        ...
                        <th style="padding: 20px 16px; text-align: left; color: white; font-weight: 600; border: none; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.5px;">Perfil</th>
                ...
                <tbody>
                    <?php foreach ($usuarios as $usuario): ?>
                        <tr style="border-bottom: 1px solid rgba(30, 58, 138, 0.1); transition: all 0.3s ease;" 
                            ...
                            <td style="padding: 18px 16px; color: #1f2937; border: none; font-weight: 500;"><?= htmlspecialchars($usuario['id_usuario']) ?></td>
                            <td style="padding: 18px 16px; color: #1f2937; font-weight: 600; border: none;"><?= htmlspecialchars($usuario['nome']) ?></td>
                            <td style="padding: 18px 16px; color: #6b7280; border: none;"><?= htmlspecialchars($usuario['email']) ?></td>
                            <td style="padding: 18px 16px; color: #1f2937; border: none; font-weight: 500;"><?= htmlspecialchars($usuario['id_perfil']) ?></td>
