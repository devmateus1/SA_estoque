    ...
    <header>
        <nav>
            ...
            <div style="display: flex; align-items: center; gap: 1.5rem;">
                <span class="user-info">👤 <?php echo htmlspecialchars($_SESSION['usuario'] ?? 'Usuário'); ?> (<?php echo htmlspecialchars($nome_perfil); ?>)</span>
                ...
                <div class="dropdown">
                    ...
                    <div id="dropdown" class="dropdown-content">
                        ...
                        <a href="listar_produto.php" style="background: rgba(59, 130, 246, 0.1);">📋 Listar Livros</a>
                            ...
                            <?php foreach ($livros as $index => $livro): ?>
                                <tr 
                                    ...
                                    <td class="action-links">
                                        <a href="alterar_produto.php?id_produto=<?php echo $livro['id_produto']; ?>" class="action-edit">✏️ Editar</a>
